package com.tcc.gateway.http_errors;

import com.tcc.gateway.http_errors.exceptions.*;
...
public class ApiExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity authentication(Exception exception) {
        return ResponseEntity.status(UNAUTHORIZED).body(new ErrorMessage(exception, UNAUTHORIZED.value()));
    }
